...
func TestDeriv(t *testing.T) {
	...
	a.Add(util.LabelsToProto(metric), 1493712816939, 1.0, metric.Hash())
	a.Add(util.LabelsToProto(metric), 1493712846939, 1.0, metric.Hash())
